...
drupal_add_js($module_path."/js/jquery-1.5.1.min.js") ; 
...
drupal_add_js($module_path."/spa_page.js") ;  
drupal_add_css($module_path."/spa_page.css") ;  
drupal_add_js( array('frontpage' => $url) , 'setting') ; 

echo drupal_get_form('joury_register_service_client_form_spa'); 
